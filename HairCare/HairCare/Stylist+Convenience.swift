...
//        
//        return StylistRepresentation(id: id, firstName: firstName, lastName: lastName, city: city, state: state, email: email, password: password, photo: photo, specialty: specialty, reviews: reviews)
//    }
//    
...
//                  reviews: stylistRepresentation.reviews
//                  context: context)
//    }
//}
